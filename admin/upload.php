						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li>
								...
								<a class="hidden-sm hidden-md hidden-lg" href="../form/logout">Cerrar sesion</a>
		 						<div class="dpdwmr hidden-xs">									<button onclick="myFunction()" class="btn btn-info btn-button">Opciones</button>
		...
		<section class="container main">
			<div class="row">
				<div class="col-md-9 panel-upload">
					...
					<p class="alert alert-warning" role="alert">Para subir un comic es <strong>obligatorio</strong> saber tu ID; tu ID es: <span style="color:blue"><strong><?php echo $crow['Id']; ?></strong></span></p>
					<form action="../form/insertar.php" enctype="multipart/form-data" method="post">
						<div class="form-group">
							<input type="text" class="form-control" placeholder="Nombre del Comic" name="nombre">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" placeholder="Autor del Comic" name="autor">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" placeholder="Generos" name="genero">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<input type="text" size="3" maxlenght="3" class="ID" placeholder="ID" name="id">
						</div>
						<div class="form-group">
